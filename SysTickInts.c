...
void SysTick_Init(uint32_t period) {
	...
	DAC_Init(); // Initialize DAC so it can use the Data and wave variables
}

// Place functions to be executed after the timer has finished here:
void SysTick_Handler(void){

    DAC_Out(); // Output a value to the DAC
